...
async function main() {
  ...
  const whitelistUsers = [
    ...
    { discordId: "377076232254390273", callsign: "M-004", rol: "user", name: "Neiconi Petrica" },
    { discordId: "323874759962132502", callsign: "M-005", rol: "user", name: "Brown Allanon" },
    { discordId: "556128906357374996", callsign: "M-006", rol: "user", name: "Mihail Parvu" },
    { discordId: "889089062844137532", callsign: "M-007", rol: "user", name: "Rares Barbu" },
    { discordId: "1142522913510146129", callsign: "M-008", rol: "user", name: "Paduraru David" },
    { discordId: "793944399913680916", callsign: "M-009", rol: "user", name: "Marius Mark" },
